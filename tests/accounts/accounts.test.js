...
assert.strictEqual(accounts[0].openingBalance,100000,'preview must not mutate opening balance');
assert.strictEqual(transfers.length,1,'opening balance preview must not rewrite history');
