...
function investmentContributionEligible(group,recurringTypes=['stock','bond','fund','crypto','gold']){return !!group&&new Set(recurringTypes.map(String)).has(String(group.typeKey||''));}
