...
function investmentPortfolioActual(transfers,month,year){return sumRows(transfers,t=>(t?.purpose==='investment'||t?.purpose==='asset')&&rowInMonth(t,month,year));}
