// Möngö Savings — Phase 1A
// Pure goal/savings calculations. Transfers remain movements, not expenses.
(function(global){
'use strict';
...
global.MongoSavings=Object.freeze({transferContribution,interestContribution,autoSaved,effectiveSaved,progressPct,addMonthsSafe,monthsBetweenCeil,calendarMonthsDaysBetween});
})(window);
