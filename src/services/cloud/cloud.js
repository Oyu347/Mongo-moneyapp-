// Möngö Cloud — Phase 1A
// Pure cloud/local ordering and clear-barrier decisions. No Firebase, storage or UI side effects.
(function(global){
'use strict';
...
global.MongoCloud=Object.freeze({stamp,chooseCloudOrLocal,candidateTime,sortNewestCandidates,chooseClearBarrier,queueItemAllowedAfterClear,filterQueueAfterClear});
})(window);
