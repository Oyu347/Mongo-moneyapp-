...
function diagnosticSnapshot(){
  ...
  return Object.freeze({mongoCloudLoaded:true,requiredMirrors:[...REQUIRED_MIRRORS],lastFinancialWriteError,globals:diagnosticGlobals(),cloudDom:diagnosticCloudDom(),capturedAt:new Date().toISOString()});
}
